...
- 번들된 기본 rulebook은 금지 문구와 과도한 단정 표현을 막는 용도로 가볍게 유지합니다.
- 이번 문서에 꼭 들어가야 하는 문구가 있으면 `이 문구를 꼭 넣어줘`라고 사용자 요청으로 주는 방식이 더 적합합니다.
- 반복 업무에서만 항상 필요한 문구라면 그때 별도 rulebook이나 reference로 승격하는 것이 좋습니다.
